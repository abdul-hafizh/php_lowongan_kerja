...
<tr valign='top'>
  ...
  while ($data = mysql_fetch_array($hasil))
  {
    ...
    echo "
	  ...
	  <a href='data_tampil/detail_lowongan.php'><img src='images/detail.jpg'></a>
	  </pre> </fieldset>
 	  </td> </tr>"; 
		}
	}
...
?>
<td valign='top'> <br/> 
		<form action='hasil_pencarian/pencarian_kota.php' method='post'>
		...
		<h3>Berdasarkan Kategori</h3>
			...
			<?php
				echo "
				<li>
					<a href='hasil_pencarian/pencarian_kategori.php?id_kategori={$baris2['id_kategori']}'>$nama_kategori</a>
				</li>";
			?>
			</ul> 
			<?php } ?>
